...
const TabFretboardVisualizer = ({ tabData = {}, onTabDataChange }) => {
  ...
  const currentMeasure = useMemo(() => {
    // Use the utility function to get current measure index
  ...
  const totalMeasures = useMemo(() => {
    return (currentTabData.measures && Array.isArray(currentTabData.measures)) ? 
      currentTabData.measures.length : 0;
